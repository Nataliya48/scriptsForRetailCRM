...
try {
    $response = $client->request->ordersList([
        'createdAtFrom' => '2019-04-05 17:00',
        'createdAtTo' => '2019-04-08 16:00'
    ], null, 20);
...
if ($response->isSuccessful()) {
    ...
    for ($page = 1; $page <= $totalPageCount; $page++){
        $responseOrdersList = $client->request->ordersList([
            'createdAtFrom' => '2019-04-05 17:00',
            'createdAtTo' => '2019-04-08 16:00'
        ], $page, 20);
    ...
    file_put_contents(__DIR__ . '/orders.log', json_encode([
